...
if __name__=="__main__":
	...
	parser.add_argument("-p", "--pol", type=str, help="Pols to dump (pol00, pol11, pol01)")
	parser.add_argument("-o", "--outdir", type=str, help="directory to store pols")
	parser.add_argument("-t", "--time_frag_length", type=int, help="Time fragment length for directory")
	parser.add_argument("-T", "--tfile", type=int, help="time in minutes for file")
