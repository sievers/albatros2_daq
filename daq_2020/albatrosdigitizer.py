...
class AlbatrosDigitizer:
    ...
    def initialise_fpga(self, fpg_file, fftshift, acclen, bits, spec_per_packet, bytes_per_spectrum, prog_tries=3):
    ...
    def initialise_adcs(self, ref_clock, adc_digital_gain, adc_tries=3):
